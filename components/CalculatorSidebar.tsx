...
export default function CalculatorSidebar({
  environment, costPerCreditUSD, overheadPct,
  setEnvironment, setCost, setOverhead, reset,
  onOpenRateManager, rateSheetUrl,
  rates, inputs, result, chartsRef
}: Props) {
  return (
    <aside className="no-print space-y-3">
      <div className="card p-3 space-y-3">
        ...
        <div>
          ...
          <div role="radiogroup" aria-label="Environment" className="grid grid-cols-2 bg-slate-100 rounded-lg p-0.5">
        ...
        <div>
          ...
          <input
            ...
            aria-label="Cost per credit in US dollars"
          />
        </div>
      ...
      <div className="card p-3 space-y-2">
        ...
        <a
          ...
          title={`View Salesforce rate sheet PDF: ${rateSheetUrl}`}
        >
        ...
        <button
          ...
          className="w-full btn-ghost text-xs py-1.5 px-2"
          title="View, update, or upload a new rate sheet"
        >
          Manage Rate Sheet
        </button>
      </div>
