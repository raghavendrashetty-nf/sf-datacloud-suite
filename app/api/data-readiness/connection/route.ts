...
export async function GET() { return NextResponse.json({ info: getConnectionInfo() }); }
...
export async function DELETE() { clearConnection(); return NextResponse.json({ ok: true }); }
